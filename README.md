...
> **Version 1.0** · **Licence CC BY-NC 4.0** · **Compatible toute IA conversationnelle**
...
**Test d'accessibilité = test d'opposabilité (levier fort).**
...
- Au niveau UE : les normes harmonisées rendues obligatoires par le droit de l'Union doivent être **librement accessibles**, l'intérêt public à l'accès au droit primant sur le droit d'auteur de la norme (CJUE, gr. ch., *Public.Resource.Org*, C-588/21 P, 5 mars 2024, ECLI:EU:C:2024:201).
- **Conséquence à exploiter** : « si c'est vraiment obligatoire, ça doit être gratuit ; si c'est payant, c'est en principe volontaire. » Une norme payante brandie comme une obligation légale est soit un abus, soit une simple règle de l'art. Et une norme *réellement* obligatoire mais non librement accessible voit son **opposabilité fragilisée**.
...
Identifier les **domaines engagés**, puis dresser la carte des textes potentiellement applicables (nationaux et supranationaux), regroupés par domaine.
...
- **Test d'accessibilité (indice d'opposabilité)** : gratuite (droit ou norme obligatoire) ou payante (indice fort de volontaire) ? Signaler toute norme payante présentée comme obligation légale, et toute norme prétendument obligatoire mais non librement accessible.
- **Conclusion** : obligation juridique, référence volontaire, ou simple recommandation ?
...
**Structure de la réponse, dans cet ordre :** (1) domaines détectés + criticité · (2) tableau · (3) synthèse en 3 lignes · (4) réserves honnêtes → questions.

### Tableau
| Exigence | Statut | Vérifié ? | Simplification possible (en 1 phrase) | Qui valide (résolu) |
|---|---|---|---|---|

- **Statut** : 🟢 Obligatoire (opposable, gratuit) · 🟡 Volontaire (norme / règle de l'art, souvent payante) · 🔴 Inapplicable (abrogé, hors champ, doublon)
- **Vérifié ?** : ✅ source citée · ⚠️ à confirmer
- **Qui valide** : organisme **nommé** + voie de saisine, ou **« aucun — simple constat de droit »**.

### Synthèse (3 lignes)
- **Alléger maintenant** (🟡 / 🔴) : … — faible risque, constat de droit.
- **À instruire** (sur-transposition, dérogation, moyen équivalent) : … — organisme à saisir : …
